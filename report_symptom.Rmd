---
title: "Analyzing the Causal Crowd Behaviors of COVID-19 and the Impact of Pandemic on  Public Mental Health for Developing a Predictive Model of COVID-like-illness"
output:
  pdf_document: 
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=25, fig.height=10,fig.cap="Lagged correlation between CLI and various behavioural aspects in low-middle and high income countries"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=25, fig.height=15,fig.cap="Lagged correlation between CLI and various behavioural aspects in countries with highest COVID cases"}
tm_country = c("India")
...
```
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=20, fig.height=20, fig.cap="Correlation between CLI and usage of mask"}
fig_title <- ""
tm_fig<-plot_gen.mask_usage(fig_title, which_month = 0)
tm_fig
```
...
```
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=25, fig.height=15, fig.cap="Lagged correlation between CLI and usage of mask in countries with highest COVID cases"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=25, fig.height=10, fig.cap="Lagged correlation between CLI and people worry of becoming ill in low-middle and high income countries"}
...
p1 <- plot_gen.income_country.lagged_corr(tm_colnames, tm_country, tm_age_list,
                              "Lagged correlation between covid like illness (cli %) and people worry of becoming ill in low-middle income countries")

tm_country = high_income_country
p2 <- plot_gen.income_country.lagged_corr(tm_colnames, tm_country, tm_age_list,
                              "Lagged correlation between covid like illness (cli %) and people worry of becoming ill in high income countries ")
tm_fig<-ggarrange(p1, p2, ncol = 1, nrow = 2)
tm_fig
```

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=25, fig.height=10, fig.cap="Lagged correlation between CLI and people worry of becoming ill in countries with most COVID-19 cases (India, Brazil, Russia)"}
tm_colnames = c("worried_ill_covid19_very_weighted", "worried_ill_covid19_somewhat_weighted", 
                      "worried_ill_covid19_notTooWorried_weighted", "worried_ill_covid19_notWorried_weighted","cli_weighted")
tm_age_list <- c("18-34", "35-54", "55+", "overall")
tm_fill <- c("#60A1F5", "#83E68C", "#F5DD65", "#954FF5")
...
tm_country = c("India")
p1 <- plot_gen.income_country.lagged_corr(tm_colnames, tm_country, tm_age_list,
                              "Lagged correlation between covid like illness (cli %) and people worry of becoming ill in India")

tm_country = c("Brazil")
p2 <- plot_gen.income_country.lagged_corr(tm_colnames, tm_country, tm_age_list,
                              "Lagged correlation between covid like illness (cli %) and people worry of becoming ill in Brazil")

tm_country = c("Russia")
p3 <- plot_gen.income_country.lagged_corr(tm_colnames, tm_country, tm_age_list,
                              "Lagged correlation between covid like illness (cli %) and people worry of becoming ill in Russia")

tm_fig<-ggarrange(p1, p2, p3, ncol = 1, nrow = 3)
tm_fig
```
...
tm_fig<-plot_gen.worried(fig_title, which_month = 0)
tm_fig
```
